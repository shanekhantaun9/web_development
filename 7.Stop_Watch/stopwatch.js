$(function(){
	...
	var action;	//varibale for setInterval
	var lapNumber = 0;	//Number of laps
		//minutes,second,centiseconds for time and lap
	...
	//functions
	//hideshow Buttons function shows two buttons
	...
	//addLap functions: print lap details inside the lap box
	function addLap(){
		lapNumber++;
		var myLapDetails =
		'<div class="lap">'+ 
